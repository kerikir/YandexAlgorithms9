...
Задача: Большое и кратное трем - определить наибольшее число, которое можно составить из данных цифр,
                                 чтобы оно делилось на три без остатка

Сложность = O(N)
Ограничения: 3 <= N <= 100_000
